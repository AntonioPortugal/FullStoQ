...
namespace Recodme.RD.FullStoQ.FullStoQTest
{
    ...
    public class ReservedQueueTest
    {
        ...
        //    var resList = bo.List();
        //    var item = resList.Result.FirstOrDefault();
        //    item.EstablishmentId = "another";
        //    var resUpdate = bo.Update(item);
        //    var resNotList = bo.ListNotDeleted().Result;
        //    Assert.IsTrue(resUpdate.Success && resNotList.First().EstablishmentId == "another");
        //}
        ...
        //    Assert.IsTrue(resList.Success && resUpdate.Success && resList.Result.First().EstablishmentId == "another");
        //}
